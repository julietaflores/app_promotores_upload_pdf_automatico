...
export class UtilService {
  ...
  public cantidad_notificaciones:any=0;
  public tipo_venta_solicitud:any='1';
  public tipo_venta_solicitud_detalle:any='';
  public comentario_soli:any='';
  public nombre_documento:any='';
  orderStatus = [
    'Created',
    'Accepted',
    'Prepared',
  ...
  reloadComponent(routes: any, param?: NavigationExtras | undefined) {
    const currentUrl = this.router.url;
    console.log(currentUrl);
    console.log(routes);
      this.router.navigate([routes],param).then(() => {
